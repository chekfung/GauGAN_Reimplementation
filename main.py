...
def fid_function(real_image_batch, generated_image_batch):
	...
	"""
	# FIXME: Clean up 299 by making it its own constant later on
	#INCEPTION_IMAGE_SIZE = (299, 299)
	INCEPTION_IMAGE_SIZE = (96, 128)
...
def train(generator, discriminator, dataset_iterator, manager):
	...
	for iteration, batch in enumerate(dataset_iterator):
		...
		# FIXME: Seems that the FID function is being wacky and I do not know how to fix it
		...
		with tf.device('/device:' + args.device):
			if args.mode == 'train':
				for epoch in range(0, args.num_epochs):
					...
					print("Average Discriminator Loss: ", str(avg_d_loss))
